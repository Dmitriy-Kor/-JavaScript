class Game {
    ...
    isCorrectClick(event) {
        // проерка статуса игры, проверка клика по ячейки TD и проверка пустая ячейка
     ...
     */
    hasWon() {
        // проверяем строки, колонки, диагонали методом isLineWon
     ...
     */
    isLineWon(a, b, c) {
        // получаем содержимое массива и конкатенируем строки
